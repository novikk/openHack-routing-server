...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("87023b40-8200-4d93-83f8-5018062ec1a0 208211659925455596 openHack openhack".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in openhack package as a set of config entries
        return configLoader.fromResource("openhack/settings");
    }
